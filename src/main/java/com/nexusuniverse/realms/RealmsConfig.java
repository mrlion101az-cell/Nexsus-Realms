...
public class RealmsConfig {
    ...
    /** Shown entering unclaimed land (from anyone's territory, or on first join). Blank disables just this message. */
    public String borderMessageEnteringWilderness() {
        return plugin.getConfig().getString("border.messages.entering-wilderness", "&7&lEntering the wilderness");
    }
}
