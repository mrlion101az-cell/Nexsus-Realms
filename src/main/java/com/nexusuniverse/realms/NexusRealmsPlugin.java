...
public class NexusRealmsPlugin extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        getServer().getPluginManager().registerEvents(new ProtectionListener(teams, land, personalClaims), this);

        getCommand("team").setExecutor(new TeamCommand(teams, hints));
        getCommand("realms").setExecutor(new LandCommand(teams, land, config, hints));
