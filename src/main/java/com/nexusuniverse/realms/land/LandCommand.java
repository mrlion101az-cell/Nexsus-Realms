...
public class LandCommand implements CommandExecutor {
    ...
    public LandCommand(TeamManager teams, LandClaimManager land, RealmsConfig config, HintManager hints, VaultHook economy) {
        this.teams = teams;
        this.land = land;
        this.config = config;
        this.hints = hints;
    ...
    private void sendUsage(Player player) {
        player.sendMessage(ChatColor.YELLOW + "Usage: /realms <claim|unclaim|info|tiers|upgrade <chunks>"
                + "|wilderness <build|containers|doors|pvp|elytra> <on|off>>");
    }
