...
public class GuidebookItem {
    ...
    public ItemStack create() {
        ...
        List<List<String>> sections = List.of(
                ...
                List.of(
                        "== Region Editing ==",
                        "/redit wand gives you a selection tool. Left-click sets position 1, right-click sets position 2.",
                        "/redit set, replace, walls, and outline all need a material name.",
